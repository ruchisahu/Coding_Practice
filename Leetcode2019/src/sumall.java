...
public class sumall {
	...
	*/
	    ...
	    public static List<List<Integer>> kSumII(int[] nums, int k, int target) {
	    ...
	    private static List<List<Integer>> kSum(int[] nums, int fixedIndex, int k, int target) {
	    ...
	    private static void perform2Sum(List<List<Integer>>res, int[] nums, int start, int end, int target) {
	        while (start < end) {
	    ...
	    private static List<List<Integer>> oneSum(int[] nums, int target) {
	        List<List<Integer>> res = new ArrayList<>();
	...
	public static void main(String[] args) 
	{
		...
		int k=4;
		int target=0;
		System.out.println(kSumII(nums, k, target));
